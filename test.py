...
# input = "Give me 1 zip code that is near an international airport."
# # # num_records = st.text_input("")

# get_res = get_response(input)

# zipcode = get_zip_code(get_res)

# response = request_zillow_page(get_res)
# # # print("response: ", response)

# coords = parse_coords(response)
# # coords = {'west': '', 'east': '', 'north': '', 'south': ''}
# print("coords: ", coords)
# zillow_records = pull_zillow_records(coords)

# zillow_links = return_df(zillow_records)